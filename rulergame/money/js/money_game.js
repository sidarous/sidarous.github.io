...
function drawCorrection(correct, incorrect){
	...
	/////////////////////////////// modified by RUH on 1st, Sep //////////////////////////////////////////////////
        $("#txtQuestion").html("<span class='questionWrongInstruction'>You selected</span><br><span class='questionWrongMeasurement'>$ " + (stgDifficulty == "Decimals" ? incorrect.toFixed(2) : incorrect) + " " +  "</span>").fadeIn();
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function showNewQuestion() {
	...
	///////// modified by RUH on 1st ,Sep ////////////////////////////////////////////////////////////
	html = "<span class='questionInstruction'>Drop bills and coins to match </span><br>";
    //////////////////////////////////////////////////////////////////////////////////////////////////
